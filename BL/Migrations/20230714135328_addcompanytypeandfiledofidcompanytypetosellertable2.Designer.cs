...
namespace BL.Migrations
{
    ...
    [Migration("20230714135328_addcompanytypeandfiledofidcompanytypetosellertable2")]
    partial class addcompanytypeandfiledofidcompanytypetosellertable2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domains.TbAboutU", b =>
                {
                    ...
                    b.Property<string>("CreatedByEn1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("FirstTextEn1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("FirstTitleEn1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SecondTextEn1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SecondTitleEn1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ThirdTtitleEn1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domains.TbBlogBlogTag", b =>
                {
                    b.Property<Guid?>("BlogBlogTagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("BlogTaName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BlogTaNameEn")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("BlogBlogTagId");

                    b.ToTable("TbBlogBlogTags");
                });
            ...
            modelBuilder.Entity("Domains.TbBlogItemSeller", b =>
                {
                    ...
                    b.Property<string>("ShortDescroptionEn")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domains.TbBlogTag", b =>
                {
                    b.Property<Guid?>("BlogTagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domains.TbCompanyType", b =>
                {
                    b.Property<Guid?>("CompanyTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("CompanyTypeEn")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domains.TbItemSeller", b =>
                {
                    ...
                    b.Property<bool>("BestSellingEGiftCard")
                        .HasColumnType("bit");

                    b.Property<bool>("BestSellingGiftCard")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("NumberOfAddFavourite")
                        .HasColumnType("int");

                    b.Property<string>("NumberOfSalesTransaction")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domains.TbItemSellerImages", b =>
                {
                    b.Property<Guid?>("ItemSellerImageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("RegionNavigationRegionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ItemSellerImageId");

                    b.HasIndex("ItemId");

                    b.HasIndex("RegionNavigationRegionId");

                    b.HasIndex("SellerId");

                    b.ToTable("TbItemSellerImagess");
                });
            ...
            modelBuilder.Entity("Domains.TbOrder", b =>
                {
                    ...
                    b.Property<string>("OrderPriceAfterPromocode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OrderPriceBeforePromocode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domains.TbOrderDetails", b =>
                {
                    ...
                    b.Property<string>("ItemSalePriceAfterPromocode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domains.TbTransaction", b =>
                {
                    ...
                    b.Property<string>("temSalePriceAfterPromocode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domains.VwHighestSalesIteSeller", b =>
                {
                    b.Property<Guid?>("ItemSellerId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("NumberOfSalesTransaction")
                        .HasColumnType("int");

                    b.ToView("VwHighestSalesIteSeller");
                });

            modelBuilder.Entity("Domains.VwItemSellerEvalauationParameters", b =>
                {
                    b.Property<Guid?>("ItemSellerId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("ParameterFourStarts")
                        .HasColumnType("int");

                    b.Property<int?>("ParameterOneStarts")
                        .HasColumnType("int");

                    b.Property<int?>("ParameterThreeStarts")
                        .HasColumnType("int");

                    b.Property<int?>("ParameterwoStarts")
                        .HasColumnType("int");

                    b.ToView("VwItemSellerEvalauationParameters");
                });

            modelBuilder.Entity("Domains.VwItemSellerFavouriteCount", b =>
                {
                    b.Property<Guid?>("ItemSellerId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("NumberOfAdd")
                        .HasColumnType("int");

                    b.ToView("VwItemSellerFavouriteCount");
                });
            ...
            modelBuilder.Entity("Domains.TbItemSellerImages", b =>
                {
                    ...
                    b.HasOne("Domains.TbRegion", "RegionNavigation")
                        .WithMany()
                        .HasForeignKey("RegionNavigationRegionId");
