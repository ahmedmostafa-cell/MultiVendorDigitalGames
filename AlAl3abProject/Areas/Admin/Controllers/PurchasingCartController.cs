...
namespace AlAl3abProject.Areas.Admin.Controllers
{
    ...
    public class PurchasingCartController : Controller
    {
        ...
        public PurchasingCartController(SellerService SellerService, ItemService ItemService, PurchasingCartService PurchasingCartService, AlAl3abDbContext context)
        {
