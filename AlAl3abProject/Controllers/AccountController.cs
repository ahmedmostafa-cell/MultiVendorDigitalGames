...
using System.Linq;
using EmailService;
using AlAl3abProject.Controllers;
using AlAl3abProject;
using AlAl3abProject.Dtos;
...
namespace AlAl3abProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly IEmailSender _emailSender;
        public AccountController(ISMSService smsService, IEmailSender emailSender, AlAl3abDbContext db,  UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager,
