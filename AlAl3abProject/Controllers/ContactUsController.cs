...
namespace AlAl3abProject.Controllers
{
    ...
    {
        private readonly ContactUService contactUService;
        ...
        public async Task<IActionResult> IndexAsync()
        {
            ...
            oIndexHomePageModel.elelmentContactUs = contactUService.getAll().FirstOrDefault();
